window.MINIMBA_DATA = {
  ...
  modules: [
    ...
    },
    {
      ...
      subtitle: "Как найти клиента и создать ценное предложение",
      color: "violet",
      comingSoon: true,
      topics: [
        "Сегмент и потребности клиента",
        "Исследование рынка",
    ...
    },
    {
      ...
      subtitle: "Как вести за собой без давления и сохранять доверие",
      color: "blue",
      comingSoon: true,
      topics: [
        "Самопознание и психотипы без ярлыков",
        "Мотивация, роли и делегирование",
        "Обратная связь и трудные разговоры",
        "Конфликты: интересы и договорённости"
      ],
      weeks: []
    },
    {
      ...
      subtitle: "Как превратить идею в результат в срок",
      color: "green",
      comingSoon: true,
      topics: [
        "Цель, результат и границы работ",
        "План, этапы и зависимости",
        "Ресурсы, бюджет и риски",
        "Ключевые показатели эффективности (KPI) и разбор итогов"
      ],
      weeks: []
    }
  ],
